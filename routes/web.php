...
use App\Http\Controllers\InvestorLoginController;
use App\Http\Controllers\OpportunityController;
use App\Http\Controllers\FavoriteOpportunityController;
use App\Http\Controllers\InvestmentPortfolioController;
use App\Http\Controllers\InvestorProjectController;
use App\Http\Controllers\InvestorActionsController;
...
Route::middleware('guest:investor')->group(function () {
    Route::view('/investor/login', 'investor.auth.login')->name('investor.login');
    Route::post('/investor/login', [InvestorLoginController::class , 'login'])->name('investor.login.submit');
});
...
Route::middleware('auth:investor')->prefix('investor')->group(function () {
    ...
    Route::get('fillter-opportunities', [OpportunityController::class, 'fillter_opportunities']);
    ...
    Route::post('/admin/active/subscription/{subscription}', [\App\Http\Controllers\SubscriptionController::class,'activeSubscription'])->name('investor.admin.active_subscription');
    Route::get('/admin/subscriptions/{subscription}', [\App\Http\Controllers\SubscriptionController::class,'show'])->name('investor.admin.subscriptions.details');
    
    Route::get("/projects", [InvestorProjectController::class, "projects"])->name('projects.index');
    Route::get("/create-project", [InvestorProjectController::class, "createProject"]);
    Route::get("/view-project", [InvestorProjectController::class, "projectView"]);

    Route::get("/notes", [InvestorActionsController::class, "notes"])->name('notes.index');
    Route::get("/add-task", [InvestorActionsController::class, "addTask"]);
    Route::get("/add-note", [InvestorActionsController::class, "addNote"]);
    Route::get("/view-note", [InvestorActionsController::class, "viewNote"]);
    Route::post("/save-note", [InvestorActionsController::class, "notePost"]);
