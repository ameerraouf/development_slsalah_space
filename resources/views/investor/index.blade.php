                                    ...
                                    <div class="col-8">
                                        <div class="numbers">
                                            ...
                                            <h5 class="font-weight-bolder mt-4" >
                                                <a href="{{ route('projects.index') }}" style="color: #fff">
                                                    @auth('investor')
                                                        {{Auth::guard('investor')->user()->from ?? ""}} {{ $workspacesss }}<span>ريال</span>   -
        ...
        <div class="card-header pb-0 p-3">
            <div class="row">
                ...
                <div class="col-6 text-end">
                    <a href="{{ route('opportunities.index') }}" class="btn btn-info btn-sm mb-0">عرض الكل</a>
                </div>
            </div>
        </div>
        <br>
                ...
                <table class="table align-items-center mb-0" id="cloudonex_table">
                  ...
                  @foreach($workspaces as $key=> $workspace)
                      ...
                      <tr>
                          ...
                          <td>
                              <p class="text-xs font-weight-bold mb-0">{{isset($workspace) ? $workspace->photo . ' ' . $workspace->photo : ''}}</p>
                          </td>
                          <td>
                              <p class="text-xs font-weight-bold mb-0">{{isset($workspace) ? $workspace->company_name : ''}}</p>
                          </td>
                          <td>
                              <p class="text-xs font-weight-bold mb-0">{{trans("$workspace->company_description")}}</p>
                          </td>
                          <td>
                          ...
                          <td>
                           ...
                           <td>
                               @if($workspace->is_active == 0)
                                   <form action="{{route('investor.admin.active_subscription', $workspace->id)}}" method="post">
                                       @csrf
                                       @method('post')
