...
@section('content')
    <div class=" row">
        ...
        <div class="col text-end">
            <a href="{{ url('investor/create-project') }}" type="button" class="btn btn-info text-white">{{ __('Plan Product ') }}</a>
        </div>
    </div>
    <div class="card ">
                                    ...
                                    <div class="dropstart">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-lg-start px-2 py-3"
                                            ...
                                            <li><a class="dropdown-item border-radius-md"
                                                    href="investor/create-project?id={{ $project->id }}">{{ __('Edit') }}</a>
                                            </li>
                                            <li><a class="dropdown-item border-radius-md"
                                                    href="investor/view-project?id={{ $project->id }}">{{ __('See Details') }}</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a class="dropdown-item border-radius-md text-danger delete-btn"
                                                    href="investor/delete/project/{{ $project->id }}">{{ __('Delete') }}
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
