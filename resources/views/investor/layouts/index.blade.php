    ...
    <div class="collapse navbar-collapse  w-auto  d-print-none " id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav px-0">
            <li class="nav-item">
                ...
                <a class="nav-link {{ request()->segment(2) == 'index' ? 'active' : '' }} " id="abanoub"
                   href="/investor/index">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->segment(2) == 'opportunities' ? 'active' : '' }} " id="abanoub"
                   href="{{route("opportunities.index")}}">
                    ...
                    <span class="nav-link-text ms-3">الفرص الاستثمارية</span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->segment(2) == 'projects' ? 'active' : '' }}" id="abanoub"
                   href="{{route("projects.index")}}">
                    ...
                    <span class="nav-link-text ms-3">تخطيط الانتاج</span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link  {{ request()->segment(2) == 'notes' ? 'active' : '' }}" id="abanoub"
                   href="{{route("notes.index")}}">
                    ...
                    <span class="nav-link-text ms-3"> اعداد الملاحظات</span>
                </a>
