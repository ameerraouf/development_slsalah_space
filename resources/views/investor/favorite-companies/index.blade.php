...
{{--                                            <a class="btn btn-info" href="{{route('admin.subscriptions.details', $workspace->id)}}">عرض التفاصيل</a>--}}
                                            <div class="d-flex align-items-center gap-3">
                                                <a class="fs-5 {{in_array($workspace->id, $investment_portfolios)? 'text-green':'text-grey'}}" onclick="MyInvestmentPortofolio({{$workspace->id}})" id="investment_portfolio_{{$workspace->id}}" href="javascript:void(0)"><i class="fa-solid fa-wallet"  title="إضافة لمحفظتي الاستثمارية" aria-hidden="true"></i></a>
