<div class="box-chat">
            ...
            <div class="preview">
                        ...
                        <div class="card-body" id = "chat_bar">
                            ...
                            @foreach ($messages as $message)
                                @if(auth()->user())
                                    <div
                                        class="d-flex w-100 @if ($message->sender_type == 'admin') justify-content-start  @else justify-content-end @endif">
                                        <div class="d-flex p-2 mb-3 justify-content-start @if ($message->sender_type == 'admin') bg-primary @else bg-light text-dark @endif"
                                            ...
                                            @else
                                                <div class="w-100">
                                                    ...
                                                    <p class="lead mb-0" style="font-size:15px;@if ($message->sender_type == 'admin') color:#ffffff99;  @else color: #78787899; @endif">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div></div>
                                                        <span
                                                            style=" @if ($message->sender_type == 'admin') color:#ffffff99;  @else color: #78787899; @endif">
                                    ...
                                    @else
                                    <div
                                        class="d-flex w-100 @if ($message->sender_type == 'user') justify-content-start  @else justify-content-end @endif">
                                        <div class="d-flex p-2 mb-3 justify-content-start @if ($message->sender_type == 'user') bg-primary @else bg-light text-dark @endif"
                                            style="max-width:75%; width:fit-content; border-radius: 10px;">
                                            @if (!is_null($message->file))
                                                <a href="/download-attachment/{{ $message->file }}"
                                                    target="_blank">{{ $message->message }}</a>
                                            @else
                                                <div class="w-100">
                                                    ...
                                                    <p class="lead mb-0" style="font-size:15px;@if ($message->sender_type == 'user') color:#ffffff99;  @else color: #78787899; @endif">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div></div>
                                                        <span
                                                            style=" @if ($message->sender_type == 'user') color:#ffffff99;  @else color: #78787899; @endif">
                                                            {{ $message->created_at->format('h:m A') }}
                                                        </span>
                                                    </div>
                                                </div>
                        ...
                        <button onclick = 'scrollToBottomChat()' class="btn btn-defualt w-100 d-block rounded-0" wire:click = "openChat({{ $chat->user->id }})" id = 'chat_btn'>
                            <div class="box p-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="unreaded" {{--@if($chat->userUnreadMessages($chat->user->id) <= 0) style = 'display:none' @endif--}} id = 'user_{{ $chat->user->id }}'>
                                        <span class="badge bg-success">{{-- $chat->userUnreadMessages($chat->user->id) --}}</span>
                                    </div>                                
                                </div>
                            </div>
                        </button>
    ...
    <!-- Modal -->
    <div class="modal fade" id="uploadsFiles" tabindex="-1" aria-labelledby="uploadsFilesLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="uploadsFilesLabel">تحميل ملف</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="img" id = 'btn_upload'>
                        <img src="{{ asset('img/defualt_upload.jpg') }}" alt="defualt" class="w-100" style="cursor: pointer" >
                    </div>
                    <input type="file" name = 'fileUpload' class="form-control" hidden id = 'file_upload'>
                </div>
            </div>
        </div>
    </div>
