                        ...
                        <div class="container p-4">
                            <div class="row">
                                ...
                                <div class="col-md-12 mx-auto text-center">
                                    <h3 class="text-dark mb-">الاستثمار المطلوب</h3>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="d-flex gap-3 mb-4">
                                    ...
                                    <div class="flex-fill">
                                        ...
                                        <div class="" id="success-message-existing">
