                ...
                <div class="col-md-5 d-flex flex-column mx-auto pb-5">
                    <div class="card card-info mt-8">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form role="form text-left" method="post" action="{{ route('loginPost') }}">
                                ...
                                <div class="mb-3">
                                    <select name="account_type"  class="form-control" aria-describedby="account-type-addon">
                                        <option value="investor" @if(old('account_type') == "investor") selected @endif>مستثمر</option>
                                        <option value="pioneer" @if(old('account_type') == "pioneer") selected @endif>رائد اعمال</option>
                                    </select>
                                </div>
