                    ...
                    <div class="card-body">
                        <form role="form text-left" method="post" action="/signup">
                            ...
                            <div id="option2Fields" style="display: none;">
                                ...
                                <div class="mb-3">
                                    <input name="count_startup_company" min="1" class="form-control" type="number"
                            ...
                            <div id="option3Fields" style="display: none;">
                                ...
                                <div class="mb-3">
                                    <div class="d-flex">
                                        <input name="from" min="1" class="form-control" type="number"
                                               placeholder="{{ __('from') }}" value="{{ old('from') }}"
                                               aria-describedby="email-addon" id="option3Fields">
                                        <div style="    width: 50px;"></div>
                                        <input name="to" min="1" class="form-control" type="number"
