...
{{--            @endif--}}
            ...
            <li class="nav-item">
                <a class="nav-link @if(($selected_navigation ?? '') === 'investshow') active @endif  " href="{{ route('myPlan.investshow') }}">
                    ...
                    <span class="nav-link-text ms-3">العرض الاستثمارى</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link @if(($selected_navigation ?? '') === 'investorSearch') active @endif  " href="{{route('investors.search')}}">
                    ...
                    <span class="nav-link-text ms-3">ابحث الآن</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link @if(($selected_navigation ?? '') === 'investorFavorite') active @endif  " href="{{route('investors.favorite')}}">
                    ...
                    <span class="nav-link-text ms-3">المفضلة</span>
                </a>
            </li>
