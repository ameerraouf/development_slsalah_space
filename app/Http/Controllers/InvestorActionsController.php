...
class InvestorActionsController extends BaseController
{
    ...
    public function notes()
    {
        ...
        return \view("investor.actions.notes", [
    ...
    public function addNote(Request $request)
    {
        ...
        return \view("investor.actions.add-note", [
            "selected_navigation" => "notes",
            "note" => $note,
        ]);
    }
    ...
    public function viewNote(Request $request)
    {
        ...
        return \view("investor.actions.view-note", [
            "selected_navigation" => "notes",
            "note" => $note,
            "users" => $users,
        ]);
    ...
    public function notePost(Request $request)
    {
        ...
        return redirect("investor/notes");
    }
}
