...
class InvestorProjectController extends BaseController
{
    public function projects()
    {
        ...
        return \view("investor.projects.projects", [
    ...
    public function createProject(Request $request)
    {
        ...
        return \view("investor.projects.create-project", [
            "selected_navigation" => "projects",
            "project" => $project,
    ...
    public function projectView(Request $request)
    {
        ...
        return \view("investor.projects.view-project", [
            "selected_navigation" => "projects",
            "project" => $project,
            "members" => $members,
            "users" => $users,
    ...
    public function projectViewDiscussion(Request $request)
    {
        ...
        return \view("investor.projects.project-discussions", [
            "selected_navigation" => "projects",
            "project" => $project,
